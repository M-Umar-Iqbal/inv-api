...
function ShopAddToHome(props) {
  ...
  function getAll(){
    axios.get('https://product-store-v1.herokuapp.com/get-all-stores').then((response) => {
        ...
        {/* style={{ maxHeight: "570px", overflowY: "auto", }} */}
          <Table aria-label="simple table" >
            <TableHead style={{backgroundColor:"#222f3e"}}>
              <TableRow >
                <TableCell style={{color:"#FFFFFF"}}><b>Shop Name</b></TableCell>
                <TableCell style={{color:"#FFFFFF"}}><b>Categories</b></TableCell>
                <TableCell style={{color:"#FFFFFF"}} align="center"><b>Explore</b></TableCell>
              </TableRow>
           </TableHead>
            ...
            <TableBody>
             
              {
                Stores ?
                  ...
                  <TableRow>
                  <TableCell colSpan={4}>
                  <div style={{ padding: "20px" }}><b>Please Wait! </b><p> Loading Data From API ...</p>
                      </div>
